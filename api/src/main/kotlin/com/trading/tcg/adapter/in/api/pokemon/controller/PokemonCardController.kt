package com.trading.tcg.adapter.`in`.api.pokemon.controller

import com.trading.tcg.adapter.`in`.api.pokemon.dto.FindPokemonCardsRequest
import com.trading.tcg.adapter.`in`.swagger.pokemon.PokemonCardSwagger
...
class PokemonCardController(
    ...
    @GetMapping("/pokemon-cards/{cardId}")
